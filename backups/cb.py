...
def get_bot_response(user_input, conversation_history):
    ...
    if any(greeting in user_input for greeting in GREETINGS_IN):
        return "🩺 Say Hi, I'm Doctor AI. How may I assist you?", conversation_history
        ...
        return "🩺 Goodbye! Say bye to DrAI 👋", conversation_history
    else:
        ...
        return response.strip() or "I'm not sure how to respond to that.", conversation_history
