...
for epoch in range(num_epochs):
    running_loss = 0.0
    for inputs, labels in train_loader:  # Replaced train_dataset with train_loader here
    ...
    epoch_loss = running_loss / len(train_loader.dataset)  # Adjusted to use len(train_loader.dataset)
